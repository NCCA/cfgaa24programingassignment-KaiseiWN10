...
struct Particle
{
  ...
  Particle(ngl::Vec3 _pos, ngl::Vec3 _dir, int _life, float _size=0.1f, ngl::Vec3 _colour={1,1,1}, float _calculated_properties=0.0f, ngl::Vec3 _gradient={1,1,1},
           ngl::Vec3 _pressure={0,0,0}) :
      pos{_pos},dir{_dir},life{_life},size{_size},colour{_colour},calculated_properties{_calculated_properties},gradient{_gradient},pressure(_pressure)
      {
